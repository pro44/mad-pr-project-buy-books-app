...
public class RegisterActivity extends AppCompatActivity {
    ...
    private PageAdapter_Registration pa;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ti1 = findViewById(R.id.register_user);
        ti2 = findViewById(R.id.register_admin);
        ...
        pa= new PageAdapter_Registration(getSupportFragmentManager(), tLayOut.getTabCount());

 ...
 * Use the {@link AdminRegister#newInstance} factory method to
...
public class AdminRegister extends Fragment {
     ...
     * @return A new instance of fragment AdminRegister.
     */
    // TODO: Rename and change types and number of parameters
    public static AdminRegister newInstance(String param1, String param2) {
        AdminRegister fragment = new AdminRegister();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        username=view.findViewById(R.id.admin_name_R);
        email=view.findViewById(R.id.admin_email_R);
        password=view.findViewById(R.id.admin_password_R);
        date_of_birth=view.findViewById(R.id.admin_d_o_b_R);
        ibutton=view.findViewById(R.id.admin_date_selector);
        ph_num=view.findViewById(R.id.admin_phone);
        address=view.findViewById(R.id.admin_address);
        register_button=view.findViewById(R.id.admin_registration_button);
        fAuth = FirebaseAuth.getInstance();
        fStore= FirebaseFirestore.getInstance();
        pb=view.findViewById(R.id.pb_admin_register);
        tv=view.findViewById(R.id.admin_go_to_login);
